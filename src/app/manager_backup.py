...
class DBManager:
    ...
    def show_about(self):
        """프로그램 정보 다이얼로그 표시"""
        return self.config_manager.show_about()

    def show_user_guide(self, event=None):
        """사용자 가이드 다이얼로그 표시"""
        return self.config_manager.show_user_guide(event)
    ...
    def show_change_password_dialog(self):
        ...
        return self.config_manager.show_change_password_dialog()
    ...
    def apply_settings(self, settings):
        """설정 적용"""
        return self.config_manager.apply_settings(settings)
